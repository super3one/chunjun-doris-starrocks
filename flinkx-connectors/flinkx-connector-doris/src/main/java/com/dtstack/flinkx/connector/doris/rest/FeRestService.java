...
import com.dtstack.flinkx.connector.doris.exception.DorisConnectFailedException;
import com.dtstack.flinkx.connector.doris.options.DorisConf;
import com.dtstack.flinkx.connector.doris.options.LoadConf;
import com.dtstack.flinkx.connector.doris.rest.module.Backend;
import com.dtstack.flinkx.connector.doris.rest.module.BackendRow;
...
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.CONNECT_FAILED_MESSAGE;
...
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_TABLET_SIZE;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_TABLET_SIZE_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_TABLET_SIZE_MIN;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.ILLEGAL_ARGUMENT_MESSAGE;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.SHOULD_NOT_HAPPEN_MESSAGE;
